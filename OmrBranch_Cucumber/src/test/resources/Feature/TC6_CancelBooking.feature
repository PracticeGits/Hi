Feature: Verifying OMR Branch cancel booking
  ...
  Scenario Outline: Verifying cancel booking module by changing checkin date for created orderID
    ...
    Examples: 
      ...
      | Mightguy99* | Chiran@09 | Tamil Nadu | Puducherry | Standard/Duluxe/Suite/Luxury/Studio | 2024-03-20 | 2024-03-24 | 2-Two   | 2-Two   |       4 | Mr.        | Chiranjeevi | R        | 8220549878 | Mightguy99* | 9043592058 | Greens Tech OMR Branch | Thoraipakkam   | Smoking Room/Late Check-in/Early Check-in/Room on a high floor/Large bed | DebitCard | 2024-03-03  |